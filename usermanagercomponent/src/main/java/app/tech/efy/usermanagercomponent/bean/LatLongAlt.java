...
public class LatLongAlt extends LatLong {
	...
	public LatLongAlt(LatLong location, double altitude, boolean isGps) {
		super(location);
		mAltitude = altitude;
		this.isGps = isGps;
	}
	...
	public LatLongAlt(LatLongAlt copy) {
		this(copy.getLatitude(), copy.getLongitude(), copy.getAltitude(), copy.getIsGps());
	}

	public LatLongAlt(double latitude, double longitude, double altitude, boolean isGps) {
		super(latitude, longitude);
		mAltitude = altitude;
		this.isGps = isGps;
	...
	public String toString() {
		...
		return "LatLongAlt{" +
				superToString +
				", mAltitude=" + mAltitude + " isgps=" + isGps
				+ '}';
	}
